...
A documentation-only repository containing 8 long-form markdown guides and a skills library of 37 agentic skills following the [Agent Skills open standard](https://agentskills.io). There is no build system, no tests, and no compiled code — all content is markdown and YAML.
...
- `skills/_registry.yml` is the machine-readable catalog of all 37 skills across 8 domains: r-packages (10), containerization (4), reporting (4), compliance (4), mcp-integration (3), web-dev (3), general (6), bushcraft (3).
