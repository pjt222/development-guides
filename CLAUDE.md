...
<!-- AUTO:START:overview -->
A documentation-only repository containing 15 guides, a skills library of 299 agentic skills, 62 agent definitions, and 12 team compositions following the [Agent Skills open standard](https://agentskills.io). There is no build system, no tests, and no compiled code — all content is markdown and YAML.
...
- `guides/_registry.yml` is the machine-readable catalog of all 15 guides across 4 categories.
