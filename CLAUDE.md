...
<!-- AUTO:START:overview -->
A documentation-only repository containing 11 guides, a skills library of 273 agentic skills, 55 agent definitions, and 9 team compositions following the [Agent Skills open standard](https://agentskills.io). There is no build system, no tests, and no compiled code — all content is markdown and YAML.
...
- `agents/_registry.yml` is the machine-readable catalog of all 55 agents.
