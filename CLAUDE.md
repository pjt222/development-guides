...
<!-- AUTO:START:overview -->
A documentation-only repository containing 13 guides, a skills library of 278 agentic skills, 59 agent definitions, and 10 team compositions following the [Agent Skills open standard](https://agentskills.io). There is no build system, no tests, and no compiled code — all content is markdown and YAML.
...
- `guides/_registry.yml` is the machine-readable catalog of all 13 guides across 4 categories.
