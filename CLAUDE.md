...
- `skills/_registry.yml` is the machine-readable catalog of all 199 skills across 31 domains: r-packages (10), jigsawr (5), containerization (10), reporting (4), compliance (17), mcp-integration (3), web-dev (3), git (6), general (6), data-serialization (2), review (6), bushcraft (4), esoteric (21), design (5), defensive (6), project-management (6), devops (13), observability (13), mlops (12), workflow-visualization (6), swarm (8), morphic (6), alchemy (3), tcg (3), intellectual-property (2), gardening (5), shiny (7), animal-training (2), mycology (2), prospecting (2), crafting (1).
- `agents/_registry.yml` is the machine-readable catalog of all 33 agents.
