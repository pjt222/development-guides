...
A documentation-only repository containing 6 long-form markdown guides, a skills library of 118 agentic skills, and 18 agent definitions following the [Agent Skills open standard](https://agentskills.io). There is no build system, no tests, and no compiled code — all content is markdown and YAML.
...
3. **Agents** (`agents/` directory): Persona definitions for Claude Code subagents. Each agent is a markdown file with YAML frontmatter (`name`, `description`, `tools`, `model`, `priority`) defining *who* handles a task. Currently 18 agents across development, compliance, review, project management, DevOps, MLOps, and specialty domains.
...
- `skills/_registry.yml` is the machine-readable catalog of all 118 skills across 18 domains: r-packages (10), compliance (17), devops (13), observability (13), mlops (12), git (6), project-management (6), general (5), esoteric (6), review (5), containerization (4), reporting (4), mcp-integration (3), web-dev (3), bushcraft (3), defensive (3), design (3), data-serialization (2).
- `agents/_registry.yml` is the machine-readable catalog of all 18 agents.
