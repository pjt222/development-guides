...
Force-graph explorer for the 315-skill, 64-agent, 13-team development platform. Built with [force-graph](https://github.com/vasturiano/force-graph), R/ggplot2 icon rendering, and 9 color themes.
...
- **315 skill icons** (`icons/<domain>/`): one glyph per skill, domain-colored
