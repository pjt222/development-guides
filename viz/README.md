...
Force-graph explorer for the 298-skill, 62-agent, 12-team development platform. Built with [force-graph](https://github.com/vasturiano/force-graph), R/ggplot2 icon rendering, and 9 color themes.
...
- **298 skill icons** (`icons/<domain>/`): one glyph per skill, domain-colored
