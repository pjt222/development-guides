...
Force-graph explorer for the 267-skill, 53-agent, 8-team development platform. Built with [force-graph](https://github.com/vasturiano/force-graph), R/ggplot2 icon rendering, and 6 color themes.
...
- **267 skill icons** (`icons/<domain>/`): one glyph per skill, domain-colored
