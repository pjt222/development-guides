...
Force-graph explorer for the 262-skill, 52-agent, 8-team development platform. Built with [force-graph](https://github.com/vasturiano/force-graph), R/ggplot2 icon rendering, and 6 color themes.
...
- **262 skill icons** (`icons/<domain>/`): one glyph per skill, domain-colored
