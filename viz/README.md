...
Force-graph explorer for the 310-skill, 64-agent, 13-team development platform. Built with [force-graph](https://github.com/vasturiano/force-graph), R/ggplot2 icon rendering, and 9 color themes.
...
- **310 skill icons** (`icons/<domain>/`): one glyph per skill, domain-colored
